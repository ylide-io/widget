...
function stringifyWidgetMessage(type, payload) {
...
function postWidgetMessageTo(source, type, payload) {
    source === null || source === void 0 ? void 0 : source.postMessage(stringifyWidgetMessage(type, payload), { targetOrigin: '*' });
}
...
var Ylide = (function () {
    ...
    var SendMessagePopup = (function () {
        ...
        function messageListener(e) {
            ...
            if ((message === null || message === void 0 ? void 0 : message.type) === WidgetMessageType.SEND_MESSAGE__CLOSE) {
    ...
    var MailboxPopup = (function () {
        ...
        function messageListener(e) {
            var message = decodeWidgetMessage(e);
            if ((message === null || message === void 0 ? void 0 : message.type) === WidgetMessageType.MAILBOX__CLOSE) {
                MailboxPopup.close();
            }
        }
        return {
        ...
        init: (function () {
            ...
            return function (options) {
                ...
                buttons.forEach(function (button) {
                    ...
                    if (!address)
                        return;
                    Ylide.hasPublicKeys(address).then(function (hasKeys) {
                        if (!hasKeys)
                            return;
...
if (MutationObserver) {
    var mutationObserver = new MutationObserver(function () { return Ylide.init(); });
